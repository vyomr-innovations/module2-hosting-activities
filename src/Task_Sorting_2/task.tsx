...
const Tasks = ({availbleTask}:myType) => {
    ...
    <div className="bg-gray-400 py-1 px-3 rounded">
      {availbleTask.map((task, index) => (
        <h2
          ...
          className=" cursor-grab active:cursor-grabbing my-2 text-black border border-black border-1 p-2 text-center rounded hover:bg-yellow-500 transition-all ease-in"
        >
          {task.tasks}
        </h2>
      ))}
