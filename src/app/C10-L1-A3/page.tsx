...
const Page = () => {
  return (
    <div className='min-h-screen bg-gray-400 text-white flex justify-center items-center flex-col'>
      <h3 className='text-white text-3xl pb-[60px] font-bold'>Bubble Breathing</h3>
