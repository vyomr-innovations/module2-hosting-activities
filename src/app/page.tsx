import NavbarData from "@/lib/navbarData.json";
import Link from "next/link";
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col gap-4 items-center justify-start  bg-[url(/image/bg_image.jpg)] bg-cover bg-center p-5">
      <h5 className="text-[50px] py-5 text-red-600">Module2 Hosting Activities</h5>
...

      {
        NavbarData.map((item,index)=>(
          ...
          <div  className="col-span-6 min-w-[500px] border border-black bg-red-400  text-black py-1 px-4 rounded-lg">
            {item.activity}
          </div>
