...
const Page = () => {
  return (
    <div className="min-h-screen bg-[#F8FAFC] text-black flex justify-center flex-col items-center p-5">
      <h3 className=" font-bold text-4xl ">Chain of strength</h3>
        <div className="grid grid-cols-10  place-items-center p-5">
      {data.map((item, index) => (
          <>
          <div key={index} className="col-span-2 flex items-center justify-center  p-5">
            <h3 className="text-xl text-yellow-700  font-bold ">{item.step}</h3>
            <Image
              src={item.img}
              className=""
              width={120}
