    ...
    <div className="min-h-screen bg-gray-400 text-white flex justify-center flex-col items-center">
      ...
      <div className="grid grid-cols-12 place-items-center">
        ...
        <div className="col-span-6 p-5 flex flex-col gap-4 w-full">
         ...
         <span className="text-xl text-[#F2F001]"> Step 1:</span> Close your eyes and deep breathe through your nose.</p> 
         <p className="list-decimal text-lg font-bold">
         Feel your stomach rise as it gets filled with air.</p> 

         
         <p className="list-decimal text-lg font-bold">
         <span className="text-xl text-[#F2F001]"> Step 2:</span> Breath out while saying the letters ‘ssss’</p>

         <p className="list-decimal text-lg font-bold">
         <span className="text-xl text-[#F2F001]"> Step 3:</span> Continue making this ‘s’ sound. Feel your stomach clench as all the air is released. </p>
